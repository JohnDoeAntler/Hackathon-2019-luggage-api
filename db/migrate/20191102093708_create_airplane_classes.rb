class CreateAirplaneClasses < ActiveRecord::Migration[6.0]
  def change
    create_table :airplane_classes do |t|
      ...
      t.decimal :bin_length, null: false, precision: 12, scale: 3
      t.decimal :bin_width, null: false, precision: 12, scale: 3
      t.decimal :bin_height, null: false, precision: 12, scale: 3
      t.decimal :assignable_space_percentage, null: false, precision: 12, scale: 3
      t.decimal :purchasable_space_percentage, null: false, precision: 12, scale: 3
